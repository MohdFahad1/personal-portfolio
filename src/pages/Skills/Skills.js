    ...
    <>
      ...
      <div id='skills'>
        <div className='skills-para'>
          <p data-aos="fade-up" data-aos-duration="1000">I have learned a lot of skills as a frontend developer and I am always learning something new to add a new skill to the list
          </p>
        </div>
        <div>
          <div className='skills-container'>
            <div className='skills-content'>
              <h3 className='skills-title' data-aos="fade-up" data-aos-duration="1200">
